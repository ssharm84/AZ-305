...
namespace CourseDBFunction
{
    public static class GetCourses
    {
            ...
            ILogger log)
        {
            ...
            string _connection_string = "Server=LAPTOP-5CN627JL;Initial Catalog=CourseDB;Persist Security Info=False;User ID=ss;Password=India@12345;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
